...
Initially, this repo is started with the Endless Runner template from flutter: https://github.com/flutter/games/tree/main/templates/endless_runner

Eventually, it would be fun to integrate multiplayer functionality, like this: https://supabase.com/blog/flutter-real-time-multiplayer-game
